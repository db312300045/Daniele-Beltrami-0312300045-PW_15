...
# il l'intervallo massimo non può superare il periodo di raccolta differente per tipologia di prodott
...
# Funzione che gestisce la quantità 
        ...
        if 1<=scelta<=8:    
            if scelta==1:
                ...
                while True:
                    ...
                    console.print(table)
                    nuovamente = input("\nVuoi ricalcolare con un nuovo seme? (s/n): ").lower()
                    if nuovamente != "s":
                        break
                    else:
